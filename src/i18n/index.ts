...
const en = {
  ...
  'td.enterFirst': 'Enter the tournament to play',
...
const am: Dict = {
  ...
  'td.playTournament': 'ይጫወቱ',
  'td.playFree': 'ይጫወቱ (ነጻ)',
  'td.enterFirst': 'ለመጫወት ውድድሩን ይግቡ',
  'td.yourBest': 'ምርጥዎ',
